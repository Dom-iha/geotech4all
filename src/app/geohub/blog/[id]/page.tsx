  ...
  return (
    <>
      <div className='bg-gray-50 py-16'>
        <article className='max-w-screen-md mx-auto py-6 px-4 lg:px-8 flex flex-col gap-8 lg:gap-10 bg-main rounded-md shadow-md'>
          <Image
            src={coverSrc}
            alt=''
            className='w-full'
          ...
          <div className='text-sm lg:text-xl'>
            <p className='mb-5'>
              Before you read this article, readers discretion is advised. This
              is not to steer up another round of argument about an unfathomable
              origin of humans. You have the right to hold your views even
              though it is not in sync with what&apos;s being shared here. Know
              that, You are 100% as wrong as you 100% believe you are right! The
              difference between right and wrong is a function of perspective.
            </p>
            <p className='mb-5'>
              Now, What do you think an agnostic would tell you about God and
              the exact origin of life? Many times as humans we tend to find
              comfort in whatever soothes our curiosity. millions are devilish,
              some are good and few are best for the eternal rest of the soul.
              The task is yours to find out. Do hold this at the back of your
              mind, Science is only here to give logical reasons to God&apos;s
              unsearchable origins and to discover ideas that could help develop
              our world - At least that would help keep their pride but it
              definitely won&apos;t buy them his heart. If you want to develop
              your mind and find an eternal rest for your wandering soul, you
              better find it somewhere else. But for the next three-four
              minutes, you can lend your mind to look through another
              perspective of life.
            </p>
            <p className='mb-5'>
              ...
              a living soul. A simple summary of human origin that&apos;s
              constantly being subjected to scrutiny by every scientific
              believer. It sounds foolish and illogical to the ears of those
              with knowledge! You know, it takes a fool to believe that. The
              free-thinking human mind needs a logical reason or an explanation
              to palm their innate pride of being knowledgeable - That was the
              godlike bait used to lure them out of the garden. Well, that is
              not to doubt the veracity of such truth. It&apos;s just about how
            ...
            <p className='mb-5'>
              ...
              reproduce are those whose variation gives them a competitive
              advantage over the rest. These are the fittest in that they are
              best adapted to their environment. The favorable variations they
              possess are passed to their offspring. Darwin thus identified
              environmental pressures as the main cause of Natural selection.
              They cause favorable variation to accumulate and unfavorable
              variation to be weeded out over thousands of generations.
              Favorable variation naturally selected by the environment
              accumulates sufficiently to give rise to new species from
              ancestral species Therefore according to Darwin, Natural selection
              acting through environmental pressures is the driving force behind
              evolutionary change. Apt! From a young man who had dedicated his
              mind to the study of fossils. Well his commitment paid off as he
