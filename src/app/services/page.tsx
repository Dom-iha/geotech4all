  ...
  return (
    <>
      ...
      <section className='px-24 py-14'>
        ...
        <ul className='grid gap-32 mt-5 grid-cols-[repeat(auto-fill,_minmax(20rem,_1fr))]'>
          ...
          <li className='grid gap-8'>
            <h3 className='text-2xl font-semibold'>Field Mapping</h3>
            <p className='text-xl'>
              From spatial analysis and Geochemical plots to production of
              various kinds of maps a complete solution.
            </p>
      ...
      <section className='px-24 py-14'>
        <div>
          <h3 className='text-6xl font-bold mb-20'>Our Partners</h3>
      ...
      <section className='px-24 py-14 bg-accent'>
